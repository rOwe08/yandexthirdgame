...
namespace MvR
{
	...
	public class Sticky : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			if( freeze )
			{
				if ( transform.parent.GetComponent<Animation>() )    transform.parent.GetComponent<Animation>().Stop();
				//else if ( transform.parent.GetComponent<Animator>() )    transform.parent.GetComponent<Animator>().StopPlayback();
			...
			if( freeze )
			{
				if ( transform.parent.GetComponent<Animation>() )    transform.parent.GetComponent<Animation>().Play();
